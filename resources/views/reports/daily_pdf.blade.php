...
<body>
    <div class="page-container">
        ...
        <div class="letterhead">
            <h2>Saccess Acadamy</h2>
            <h4>Daily Payment Report</h4>
        </div>
        
        <div class="report-info">
            <p><strong>Report Date:</strong> {{ $report['date'] }}</p>
            <p><strong>Report ID:</strong> SA-{{ date('Ymd', strtotime($report['date'])) }}</p>
        </div>
        ...
        <div class="content">
            <table class="summary-table">
                ...
                <tr>
                    <td>Welfare Payments</td>
                    <td class="amount">{{ number_format($report['welfare_payments_total'] ?? 0, 2) }}</td>
                </tr>
                <tr>
                    <td>Hall Fee Payments</td>
                    <td class="amount">{{ number_format($report['welfare_payments_total'] ?? 0, 2) }}</td>
                </tr>
                <tr class="total-row">
                ...
                <tr>
                    ...
                    <td class="amount">{{ number_format($report['welfare_expenses_total'] ?? 0, 2) }}</td>
                </tr>
                <tr class="total-row">
