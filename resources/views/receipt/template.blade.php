        ...
        <div class="receipt-card">
            ...
            <div class="receipt-body">
                ...
                <div class="info-section">
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value">Grade {{ $data['student_class']['grade'] }} - {{ $data['student_class']['subject'] }}</div>
                    </div>
                    <div class="info-row">
                        <div class="info-label">Program Category</div>
                        <div class="info-value">{{ $data['class_category_has_student_class']['class_category']['category_name'] }}</div>
                    </div>
                    <div class="info-row">
                ...
                <div class="payment-details">
                    ...
                    <div class="payment-row">
                        ...
                        <div class="payment-amount">Rs. {{ number_format($data['class_category_has_student_class']['fees'], 2) }}</div>
                    </div>
            ...
            <div class="receipt-footer">
                ...
                <div class="footer-text" style="margin-top: 10px;">
                    <strong>Success Academy</strong> | Colombo 05, Sri Lanka<br>
                    Tel: +94 11 234 5678 | Email: info@successacademy.lk
                </div>
            </div>
        </div>
